...
<html>
	...
	<body>
		<section id="container">
			<form action="/cmm/memberDelete" method="post" id="delForm">
				...
				<div class="form-group has-feedback">
					...
					<input class="form-control" type="password" id="userPass" name="user_pwd" />
				</div>
				<div class="form-group has-feedback">
					<label class="control-label" for="userName">성명</label>
					<input class="form-control" type="text" id="userName" name="userName" value="${member.user_name}" readonly="readonly"/>
				</div>
			</form>
			<div class="form-group has-feedback">
